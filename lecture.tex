...
\begin{center}
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{images/rimless_wheel_fixed.jpg}
\end{center}
...
\textbf{Drones} \url{videos/quadrotor_lissajous.mp4}

\textbf{Soft Juggling} \url{videos/soft_juggler.mp4}

\textbf{Manipulation} \url{videos/pizza_tossing.mp4}

\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, breakable, titlerule=0mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black]
...
\textbf{Deterministic} \begin{center}
\includegraphics[width=\linewidth,height=3.125in,keepaspectratio]{images/deterministic.jpg}
\end{center}
\emph{Predictable. Static.}

\textbf{Stochastic} \begin{center}
\includegraphics[width=\linewidth,height=3.125in,keepaspectratio]{images/stochastic.jpg}
\end{center}
...
\emph{Real-world (Left) vs.~Sim2Real Replica (Right)}
...
\textbf{Controller Architecture} \begin{center}
...
\item
  \textbf{Current Status}: {\textbf{Broken (Moved to Dallas).}}
...
\subsection{The Ethics of AI}\label{the-ethics-of-ai}
